   ...
   <!--contenido de la plantilla -->
    ...
    <div class="container">
        ...
        <div class="row" id="contenedor_restaurantes">
                ...
                <div class="blog-card alt col-md-6">
                    <div class="meta">
                        <div class="photo" style="background-image: url(https://i1.wp.com/webadictos.com/media/2017/03/secretos-de-dominos-pizza.png?resize=800%2C420&ssl=1)"></div>
                        <ul class="details">
                            <li class="author"><a href="#">Correo@mail.com</a></li>
                            <li class="tags">
                            <ul>
                ...
                <div class="blog-card alt col-md-6">
                    <div class="meta">
                        <div class="photo" style="background-image: url(https://wheretogo.com.mx/images/restaurantes/tacos-nero/tacos-nero-logo-landing.png)"></div>
                        <ul class="details">
                            <li class="author"><a href="#">Correo@mail.com</a></li>
                            <li class="tags">
                            <ul>
                ...
                <div class="blog-card alt col-md-6">
                    <div class="meta">
                        <div class="photo" style="background-image: url(https://upload.wikimedia.org/wikipedia/commons/thumb/4/4b/McDonald%27s_logo.svg/220px-McDonald%27s_logo.svg.png)"></div>
                        <ul class="details">
                            <li class="author"><a href="#">Correo@mail.com</a></li>
                            <li class="tags">
                            <ul>
